	...
	<section class="ftco-section">
		...
		<div class="container-wrap">
			<div class="row no-gutters d-flex">
				<?php include("get_productos.php"); ?>
				<?php foreach ($productos as $producto) { ?>
					<div class="col-lg-4 d-flex ftco-animate">
						<div class="services-wrap d-flex">
							<a href="#" class="img" style="background-image: url(assets/images/<?php echo $producto['imagen_producto']; ?>);"></a>
							<div class="text p-4">
								<h3><?php echo $producto['nombre_producto']; ?> </h3>
								<p><?php echo $producto['descripcion_producto']; ?></p>
								<p class="price"><span>$<?php echo $producto['precio_producto']; ?></span>
